...
public class ArbolAVL {
    //Arbol auto balanceado AVL
    //Son abb que siempre estan equilibrados
    //La altura de la rama izq no difiere en mas de 1 unidad a la derecha y viceversa

    //Balance = Altura (hijo izq(n)) - Altura (hijo der(n))
    //Balance 1 izq>der , balance 0 iguales, balance -1 der>izq
    ...
    private String stringAux(NodoAVL nodo, String cadena) {
        cadena += "Nodo: " + nodo.getElem().toString();
