...
public class TestGenerico {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("\n");
        /*System.out.println("Pruebas de m茅todos GRADO");
        System.out.println("------------------------");
        ArbolGen vacio = new ArbolGen();
        System.out.println("Grado de 谩rbol completo: Tiene que dar 4: " + sOk + " --> " + (((int) a.grado() == 4) ? sOk : sErr));
        ...
        System.out.println("Grado de 谩rbol vac铆o: Tiene que dar -1: " + sOk + " --> " + (((int) vacio.grado() == -1) ? sOk : sErr));*/
    }
